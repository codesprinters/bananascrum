...
Warbler::Config.new do |config|
  ...
  config.dirs = %w(app db/initial db/migrate config lib log vendor/gems vendor/plugins vendor/rails tmp)
  config.includes = FileList["vendor/gems/*/.specification"]
  # Add itext jar to the output war file
  config.includes += FileList["vendor/itext/*"]
  config.gems = []
  ...
  # lib excludes
  config.excludes = FileList["lib/generators/*"]
  config.excludes += FileList[
    "lib/selenium_data_generator.rb",
    "lib/selenium_runner.rb",
    "lib/dotpay_gateway.rb"
    ]
  ...
  config.public_html = FileList["public/images/**/*"]
  config.public_html += FileList["public/javascripts/**/*"]
  config.public_html += FileList["public/stylesheets/**/*"]
  config.public_html += FileList["public/juggernaut/*"]
  config.public_html += FileList["public/open-flash-chart.swf"]
  ...
  # of RAILS_ROOT
  config.war_name = "#{RAILS_ROOT}/build/bananascrum"
