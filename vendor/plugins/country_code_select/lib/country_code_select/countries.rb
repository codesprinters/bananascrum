module CountryCodeSelect
	module Countries
		...
		["Finland", "FI"], ["France", "FR"], ["French Southern Terr.", "TF"], ["Gabon", "GA"], ["Gambia", "GM"],  
		...
		["United States", "US"], ["Uruguay", "UY"], ["Uzbekistan", "UZ"], ["Vanuatu", "VU"], ["Vatican City State", "VA"],  
		["Venezuela", "VE"], ["Vietnam", "VN"], ["Virgin Islands (British)", "VG"], ["Virgin Islands (US)", "VI"], ["Wallis & Futuna Islands", "WF"],  
		["Western Sahara", "EH"], ["Yemen", "YE"], ["Zaire", "ZR"], ["Zambia", "ZM"], ["Zimbabwe", "ZW"]]
	end
end
