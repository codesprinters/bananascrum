  ...
  class Base
    ...
    def render
      ...
      returning self.to_json2 do |output|
        ...
        %w(on_show font_size dot_size outline_colour halo_size start_angle tick_height grid_colour tick_length no_labels label_colour gradient_fill fill_alpha on_click spoke_labels visible_steps key_on_click).each do |replace|
